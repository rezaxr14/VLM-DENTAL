...
3. Use a genuinely varied toolset -- across a full trace you should typically touch most or all of the seven available tools, not just one or two. Different findings call for different tools: noisy regions need `denoise`, suspected asymmetry needs `contralateral_compare`, unclear density needs `window_level`.
