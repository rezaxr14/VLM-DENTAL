...
- `tufts.py`: **Tufts Panoramic Dataset loader.** Image discovery and tooth bounding box parser implemented (`load_tufts_tooth_boxes`), parsing 25,184 tooth annotations from 1,000 radiograph images. All 1,000 images, annotations, and polygon segmentations uploaded to Hugging Face Hub (`Reza-Nadimi/tufts-train-images`). Integrated into multi-dataset YOLO 5-fold cross-validation.
