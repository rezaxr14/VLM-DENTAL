...
**validation mAP50 = 0.9593 ± 0.0298** (mAP50-95 = 0.5895 ± 0.0346, best fold 4 mAP50 = 0.9226),
...
**Live in the agent loop**, loaded automatically from `data/models/yolo_cv_best/weights/best.pt` (or `GROUNDING_MODEL_PATH`).
- Multi-Dataset DENTEX+Tufts YOLOv8m (2,339 images) Target mAP50: **0.9593** (Target Precision: 0.9864)
