...
- **Rule:** When writing or completing meaningful chunks of code, proactively commit your changes locally to git with clear, descriptive commit messages. You do NOT need explicit user permission to make local commits.
- **Rule (NEVER PUSH):** **DO NOT** push commits (`git push`) to the remote GitHub repository. Only the user will push to GitHub after reviewing.
...
## 8. Unified Backbone & Modular Notebook Architecture
...
## 9. Multi-Provider Dynamic Verifier Pool
